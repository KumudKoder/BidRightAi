...
const { IBM_API_KEY, IBM_PROJECT_ID, IBM_URL, PORT = 5000 } = process.env;
...
app.post("/api/analyze", upload.single("pdf"), async (req, res) => {
  try {
    ...
    const prompt = `Role: Expert Bid Manager for Indian Government Tenders.
